...
exec ctags -f ~/.vim/ctags/tags \
    ...
    $git_root'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle' \
    $git_root'/vendor/symfony/symfony/src/Symfony/Component/Form' \
    $git_root'/vendor/symfony/symfony/src/Symfony/Component/HttpFoundation' \
    $git_root'/vendor/sensio/framork-extra-bundle' \
